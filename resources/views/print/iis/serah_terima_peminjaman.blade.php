...
<head>
    <meta charset="UTF-8">
    <title>Serah Terima Peminjaman Barang Gudang | Kode : {{ $data->code }}</title>
    <style>
        body {
...
<body>
    ...
    <table class="header">
        <tr>
            ...
            <td style="text-align:center;">
                ...
                <h2>SURAT SERAH TERIMA PEMINJAMAN BARANG</h2>
    ...
    <div>
        <p class="paragraph">
            Dengan ini, PJ Gudang telah menyerahkan barang-barang inventaris yang tertera di daftar ini kepada PJ
            terkait untuk keperluan pinjaman sementara. Barang-barang tersebut tetap menjadi tanggung jawab Gudang,
            namun PJ terkait bertanggung jawab atas kondisi dan penggunaan barang selama periode pinjaman.
            Harap mengembalikan barang sesuai tanggal jatuh tempo atau melalui menu Pengembalian/Pengembalian Pinjaman
            di sistem inventaris.
        </p>
    </div>
