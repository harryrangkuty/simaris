...
<head>
    <meta charset="UTF-8">
    <title>Serah Terima QR Code {{ $data->code }}</title>
    <style>
        body {
...
<body>
    ...
    <table class="header">
        <tr>
            ...
            <td style="text-align:center;">
                ...
                <h2>SURAT SERAH TERIMA PENDATAAN ULANG INVENTARIS</h2>
                <h2>DI APLIKASI SIMARIS</h2>
            </td>
    ...
    <div class="info-box">
        <table>
            ...
            <tr>
                ...
                <td>: {{ $data->pj->name }} ({{ $data->pj->identifier }})</td>
            </tr>
            <tr>
    ...
    <table class="signature">
        <tr>
            ...
            <td width="50%">
                ...
                <div class="line"></div>
                <div><strong>{{ $data->pj->name }}</strong></div>
                <div>NIK: {{ $data->pj->identifier }}</div>
                <div>{{ $data->pj->position }}</div>
            </td>
        </tr>
    </table>
    ...
    {{-- ================= APPROVALS SIGNATURE ================= --}}
    @if (count($data->approvals))
        <div style="margin-top:40px; font-weight:bold; text-align:center;">
                    ...
                    <td width="33%">
                        ...
                        <div style="margin:15px 0">
                            @if ($approval->approved_at)
                                @php
                                    $qrItem = collect($qrApprovals)->firstWhere('approval.id', $approval->id);
                                @endphp

                                @if ($qrItem)
                                    <img src="data:image/svg+xml;base64,{{ $qrItem['qr'] }}">
                                @endif
                            @endif
                        </div>
