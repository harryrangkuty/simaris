...
<template>
    ...
    <a-modal v-model:open="showModal" title="Tambah Data Kode Stok" width="600px" @ok="writeData"
        :mask-closable="false">
        <a-form ref="form" name="warehouseForm" :label-col="{ span: 7 }" :wrapper-col="{ span: 17 }"
            layout="horizontal">
            <a-form-item label="Kode Stock" name="code" :rules="[{ required: true }]">
                <a-input v-model:value="form.code" placeholder="Isi Kode Transaksi" allow-clear />
            </a-form-item>
            <a-form-item label="Nama Stok" name="name" :rules="[{ required: true }]">
