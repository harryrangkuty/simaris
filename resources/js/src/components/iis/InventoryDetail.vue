    ...
    <div class="space-y-4">
            ...
            <div class="relative">
                ...
                <template v-if="editingField !== 'description'">
                    <div class="flex gap-2 items-start">
                        ...
                        <a-button v-if="can('iis.inventories-list.update')" type="text" @click="startEdit('description')">
        ...
        <a-card size="small" class="relative overflow-hidden
            ...
            <div class="relative">
                        ...
                        <template v-if="editingField !== `etc-${index}`">
                            <div class="flex flex-col gap-1">
                                ...
                                <div class="flex items-center justify-between gap-2">
                                    ...
                                    <div v-if="can('iis.inventories-list.update')" class="flex items-center">
                ...
                <!-- ADD NEW -->
                <div v-if="can('iis.inventories-list.update')" class="mt-3 flex flex-col lg:flex-row gap-2">
            ...
            <div class="relative">
                ...
                <template v-if="editingField !== 'notes'">
                    <div class="flex gap-2 items-start">
                        ...
                        <a-button v-if="can('iis.inventories-list.update')" type="text" @click="startEdit('notes')">
