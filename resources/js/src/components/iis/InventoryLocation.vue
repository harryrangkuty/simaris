      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
        ...
        <div class="rounded-lg bg-slate-50/80 border border-slate-200/60 p-3 space-y-1.5">
          ...
          <div class="flex items-center justify-between">
            ...
            <a-button v-if="can('iis.inventories-list.update') && editingField !== 'building_id'" type="text"
        ...
        <div class="rounded-lg bg-slate-50/80 border border-slate-200/60 p-3 space-y-1.5">
          ...
          <div class="flex items-center justify-between">
            ...
            <a-button v-if="can('iis.inventories-list.update') && editingField !== 'floor'" type="text"
        ...
        <div class="rounded-lg bg-slate-50/80 border border-slate-200/60 p-3 space-y-1.5">
          ...
          <div class="flex items-center justify-between">
            ...
            <a-button v-if="can('iis.inventories-list.update') && editingField !== 'unit_id'" type="text"
          ...
          <template v-if="editingField !== 'unit_id'">
            <div class="text-sm text-slate-700">
              {{ modelData.unit?.name || modelData.unit_legacy || '-' }}
            </div>
          </template>
        ...
        <div class="rounded-lg bg-slate-50/80 border border-slate-200/60 p-3 space-y-1.5">
          ...
          <div class="flex items-center justify-between">
            ...
            <a-button v-if="can('iis.inventories-list.update') && editingField !== 'room_id'" type="text"
          ...
          <template v-if="editingField !== 'room_id'">
            <div class="text-sm text-slate-700">
              {{ modelData.room?.name || modelData.room_legacy || '-' }}
            </div>
          </template>
