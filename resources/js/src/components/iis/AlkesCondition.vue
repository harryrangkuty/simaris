      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
        ...
        <div class="rounded-lg bg-slate-50/80 border border-slate-200/60 p-3 space-y-1.5">
          ...
          <div class="flex items-center justify-between">
            ...
            <a-button v-if="can('iis.alkes-list.update') && editingField !== 'condition'" type="text"
        ...
        <div class="rounded-lg bg-slate-50/80 border border-slate-200/60 p-3 space-y-1.5">
          ...
          <div class="flex items-center justify-between">
            ...
            <a-button v-if="can('iis.alkes-list.update') && editingField !== 'is_deactivated'" type="text"
