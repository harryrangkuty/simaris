...
class IisBorrowReturnController extends AuthController
{
    public function __invoke(Request $request)
    {
        ...
        $title = 'Daftar Retur Peminjaman Barang IIS';
        $vue = "<iis-borrow-return-page :title='" . json_encode($title) . "' :constant='" . json_encode($constant) . "' />";
                ...
                return DB::transaction(function () use ($request) {
                    ...
                    if ($request->id) {
                        ...
                        $movement->update([
                            ...
                            'to_pj_id' => $warehouse->person_in_charge_id,
                            'notes' => $request->notes,
                        ]);
